...
const Footer = () => {
    return (
        <div className='mt-20'>
            <footer class="footer p-10 bg-base-300 font-semibold text-base-content">
                <div>
            ...
            <footer class="footer px-10 py-4 border-t bg-base-300 text-base-content border-base-300">
                <div class="items-center grid-flow-col">
                    ...
                    <p className='title text-3xl'>Dream shop Dinajpur</p> <br />
                    
                </div>
                <p className='mt-5 font-bold text-xl title'>Develop by MD: SHAMIM ISLAM</p>
